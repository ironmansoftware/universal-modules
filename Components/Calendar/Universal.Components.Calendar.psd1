@{
    ...
    GUID              = 'eda4d7a7-030f-4e7f-88ac-3cdc980e8ae7'
    ...
    Description       = 'Calendar component for PowerShell Universal apps.'
    ...
    FunctionsToExport = @('New-UDCalendar', 'New-UDCalendarEvent')
