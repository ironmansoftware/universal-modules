@{
    ...
    RootModule        = 'Universal.Components.Recharts.psm1'
    ...
    GUID              = 'f392661e-6d5e-4989-bb93-71cd98e23c36'
    ...
    Description       = 'Recharts component for PowerShell Universal apps.'
    ...
    FunctionsToExport = @('New-UDRechart', 'New-UDRechartLegend', 'New-UDRechartAxis')
