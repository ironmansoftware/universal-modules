...
@{
    ...
    GUID              = '24d774d8-9fcf-4d12-8a86-6f9e5a26ac06'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags       = @('PowerShellUniversal', 'Apps', 'ActiveDirectory')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/ironmansoftware/universal-modules/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/ironmansoftware/universal-modules/tree/main/Apps/Universal.Apps.ActiveDirectory'
